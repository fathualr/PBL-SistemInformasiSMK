...
<div class="lg:col-span-2 grid md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-y-14 lg:gap-y-8 lg:gap-4">
    <div
        class="card md:mx-auto rounded-b-xl w-80 h-80 lg:h-96 lg:w-96 bg-cover bg-[url(https://daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.jpg)]">
        <div
            class=" bg-dark-lochinvar/70 rounded-none rounded-b-xl py-8 lg:py-8 translate-y-[9.75rem] lg:translate-y-[13.75rem]">
