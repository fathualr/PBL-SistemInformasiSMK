...
<h1 class="font-bold text-2xl text-center my-12">SMK MUHAMMADIYAH PLUS KOTA BATAM</h1>

<div class="grid grid-cols-6 gap-4">

    <div class=" col-span-2 bg-gossamer">
        <!-- First Card -->
        <div class="card smartphone:w-60 lg:w-full h-96 md:mx-auto rounded-sm">
    ...
    <div class="col-span-4 grid grid-cols-2 p-5 gap-y-5">
...
<h1 class="font-bold text-2xl text-center my-12 divider">VISI & MISI SEKOLAH</h1>

<div class="grid grid-cols-2 gap-4">
    <!-- Visi -->
    <div class="mx-auto">
        <div class="card w-96 bg-slate-100">
...
<h1 class="font-bold text-2xl text-center my-12 divider">KOMPETENSI KEAHLIAN</h1>

<div class="grid grid-cols-3 gap-4 my-24">
    <!-- Kompetensi 1 -->
    <div class="mx-auto">
        <div class="card card-compact w-72 h-96 shadow-xl bg-indigo-600">
            ...
            <div class="card-body bg-base-100">
                <h2 class="text-center font-bold text-xl">Teknik Komputer dan Jaringan</h2>
                <p class="text-center">If a dog chews shoes whose shoes does he choose?</p>
                <div class="card-actions justify-center">
                    <!-- Modal -->
                    <button class="btn my-5" onclick="my_modal_3.showModal()">Lihat Selengkapnya</button>
    ...
    <!-- Kompetensi 2 -->
    <div class="mx-auto">
        <div class="card card-compact w-72 h-96 shadow-xl bg-red-500">
            <div class="avatar mx-auto h-28 -translate-y-10">
                <div class="w-24 h-24 rounded-full">
                    <img src="https://daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg" />
                </div>
            ...
            <div class="card-body bg-base-100">
                <h2 class="text-center font-bold text-xl">Rekayasa Perangkat Lunak</h2>
                <p class="text-center">If a dog chews shoes whose shoes does he choose?</p>
                <div class="card-actions justify-center">
                    <!-- Modal -->
                    <button class="btn my-5" onclick="my_modal_4.showModal()">Lihat Selengkapnya</button>
