...
<div class="container mx-auto p-8">
    ...
    <div class="grid grid-cols-4 grid-flow-col grid-rows-4 gap-y-5 my-10">
        ...
        <div class="col-span-1 col-start-3">
            <a href="{{ $medsos->fax }}" class="btn btn-outline flex justify-start items-center mx-auto h-max p-5 w-56">
    ...
    <div class="grid grid-cols-2 gap-5">
        ...
        <div class="col-span-2">
            <label class="form-control w-full">
                ...
                <textarea class="textarea textarea-bordered h-48" placeholder="Ketikkan Komentar Disini"
