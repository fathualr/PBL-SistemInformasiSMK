...
<h2 class="text-2xl font-bold mb-8 text-center divider">ALBUM FOTO</h2>
...
<div class="lg:col-span-2 grid md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-y-14 lg:gap-y-8 lg:gap-4">
    ...
    <div class="card md:mx-auto rounded-b-xl w-80 h-80 lg:h-72 lg:w-96 bg-cover transition-all duration-200 hover:scale-105"
        style="background-image: url('{{ asset('storage/' . $album->gambar_album) }}');">
        <div
            ...
            <div class="card-actions justify-end">
                <a href="/guest/galeri-template/{{ $album->id_album }}"
...
<div class="join flex justify-center my-5">
    ...
    <button class="join-item btn">Halaman {{ $albums->currentPage() }}</button>
