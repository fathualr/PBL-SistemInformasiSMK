...
<div class="lg:col-span-2 grid md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-y-14 lg:gap-y-8 lg:gap-4">
    ...
    <div class="card md:mx-auto rounded-b-xl w-80 h-80 lg:h-72 lg:w-96 bg-cover" style="background-image: url('{{ asset('storage/' . $album->gambar_album) }}');">
        <div class=" bg-teal-50/70 rounded-none rounded-b-xl py-3 translate-y-[12.4rem] lg:py-3 lg:translate-y-[10.4rem]">
            <h2 class="card-title px-5 text-black/80"><p class="truncate w-80">{{ $album->nama_album }}</p></h2>
