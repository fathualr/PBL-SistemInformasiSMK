    ...
    <form action="{{ route('guest.ppdb.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-4 my-5">
            ...
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-8">
                    <input type="text" id="no_hp" name="no_hp" class="input input-bordered w-full" placeholder="No Handphone Casis">
                </div>
            </div>
            ...
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-8 ">
                    <textarea id="alamat_wali" name="alamat_wali" class="textarea textarea-bordered w-full" placeholder="Alamat Wali"></textarea>
                </div>
            </div>
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-4">
                ...
                <div class="col-span-8 ">
                    <textarea id="no_hp_wali" name="no_hp_wali" class="textarea textarea-bordered w-full" placeholder="No Handphone Wali"></textarea>
                </div>
            </div>
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-4">
            ...
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-4">
                    <label class="block font-medium ml-2">File Dokumen(Prestasi,Nilai Sementara,dll...)</label>
                </div>
                <div class="col-span-8">
                    <label class="input bg-transparent border-2 input-bordered flex items-center w-full focus-within:outline-none">
                        <input type="file" id="tautan_dokumen" name="tautan_dokumen" class="grow file-input file-input-success border-none bg-transparent py-2" accept=".pdf">
                    </label>
                </div>
            </div>
            <div class="flex justify-center">
                <button type="submit" class="btn btn-success font-bold text-white w-40 my-5">Kirim</button>
            </div>
        </div>
    </form>
</div>
