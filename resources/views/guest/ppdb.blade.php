...
<script>
    // Tentukan waktu mulai dan akhir countdown
    var countdownStartDate = new Date("{{ $countdownStart }}").getTime() - new Date().getTimezoneOffset() * 60;
    var countdownEndDate = new Date("{{ $countdownEnd }}").getTime() - new Date().getTimezoneOffset() * 60;
    ...
    var x = setInterval(function() {
        ...
        // Hitung jarak antara sekarang dan waktu mulai countdown
        ...
        // Tampilkan hasilnya dalam elemen
