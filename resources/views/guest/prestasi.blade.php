...
<div class="grid grid-cols-1 gap-y-10 my-10">
    ...
    <div class="card lg:card-side bg-base-100 shadow-xl">
        ...
        <div class="card-body">
            <h2 class="text-2xl font-bold truncate smartphone:w-64 tablet:w-[25rem]">{{ $prestasi->nama_prestasi }}</h2>
            ...
            <div class="h-28 overflow-y-hidden smartphone:w-64 tablet:w-[50rem]">
