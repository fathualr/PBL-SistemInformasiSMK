    ...
    <div class="modal-box w-11/12 max-w-5xl py-0">
        ...
        <form action="{{ route('DirektoriAlumni.store') }}" method="post" enctype="multipart/form-data">
            ...
            <label class="input bg-transparent border-2 border-blue-400 flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                <input type="text" class="grow bg-transparent py-2" placeholder="Nama" name="nama_alumni" />
            </label>
            <span class="label-text -mb-4">Email Alumni :</span>
            <label class="input bg-transparent border-2 border-blue-400 flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                <input type="email" class="grow bg-transparent py-2" placeholder="Email" name="email_alumni" />
            </label>
            <span class="label-text -mb-4">No.Handphone Alumni :</span>
            <label class="input bg-transparent border-2 border-blue-400 flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                <input type="number" class="grow bg-transparent py-2" placeholder="No.Hp" name="no_hp_alumni" />
            </label>
            ...
            <label class="input bg-transparent border-2 border-blue-400 flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                <input type="number" class="grow bg-transparent py-2" placeholder="Tahun Kelulusan" name="tahun_kelulusan_alumni" />
            </label>
...
<dialog id="my_modal_edit{{ $alumni->id_alumni }}" class="modal">
    <div class="modal-box w-11/12 max-w-5xl py-0">
        ...
        <form action="{{ route('DirektoriAlumni.update', $alumni->id_alumni) }}" method="post" enctype="multipart/form-data">
            ...
            <span class="label-text -mb-4">Nama Alumni :</span>
            <label class="input bg-transparent border-2 border-blue-400 flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                <input type="text" class="grow bg-transparent py-2" placeholder="Nama" name="nama_alumni" value="{{ $alumni->nama_alumni }}" />
            </label>
            <span class="label-text -mb-4">Email Alumni :</span>
            <label class="input bg-transparent border-2 border-blue-400 flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                <input type="email" class="grow bg-transparent py-2" placeholder="Email" name="email_alumni" value="{{ $alumni->email_alumni }}" />
            </label>
            <span class="label-text -mb-4">No.Handphone Alumni :</span>
            <label class="input bg-transparent border-2 border-blue-400 flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                <input type="text" class="grow bg-transparent py-2" placeholder="No.Hp" name="no_hp_alumni" value="{{ $alumni->no_hp_alumni }}" />
            </label>
            <span class="label-text -mb-4">Tempat, Tanggal Lahir Pegawai :</span>
            <label class="input bg-transparent border-2 border-blue-400 flex items-center gap-2 mb-5 w-full focus-within:outline-none">
            ...
            <span class="label-text -mb-4">Tahun Kelulusan Alumni :</span>
            <label class="input bg-transparent border-2 border-blue-400 flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                <input type="number" class="grow bg-transparent py-2" placeholder="Tahun Kelulusan" name="tahun_kelulusan_alumni" value="{{ $alumni->tahun_kelulusan_alumni }}" />
            </label>
            <span class="label-text -mb-4">Alamat Alumni :</span>
            <textarea class="input border-2 border-blue-400 flex items-center gap-2 mb-5 w-full h-28 focus-within:outline-none grow py-2" placeholder="Alamat" name="alamat_alumni">{{ $alumni->alamat_alumni }}</textarea>
            <span class="label-text -mb-4">Foto Alumni :</span>
            <label class="input bg-transparent border-2 border-blue-400 flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                <input type="file" name="gambar_alumni" accept="gambarAlumni/*" class="grow file-input file-input-success border-none bg-transparent py-2
                    file:mr-4 file:px-4 file:rounded-full file:border-0
...
<dialog id="my_modal_view{{ $alumni->id_alumni }}" class="modal">
    <div class="modal-box w-11/12 max-w-5xl py-0">
        ...
        <span class="label-text -mb-4">Nama Alumni :</span>
        <label class="input bg-transparent border-2 border-blue-400 flex items-center gap-2 mb-5 w-full focus-within:outline-none">
            <input type="text" class="grow bg-transparent py-2" placeholder="Nama" name="nama_alumni" value="{{ $alumni->nama_alumni }}" readonly />
        </label>
        <span class="label-text -mb-4">Email Alumni :</span>
        <label class="input bg-transparent border-2 border-blue-400 flex items-center gap-2 mb-5 w-full focus-within:outline-none">
            <input type="text" class="grow bg-transparent py-2" placeholder="Email" name="email_alumni" value="{{ $alumni->email_alumni }}" readonly />
        </label>
        <span class="label-text -mb-4">No.Handphone Alumni :</span>
        <label class="input bg-transparent border-2 border-blue-400 flex items-center gap-2 mb-5 w-full focus-within:outline-none">
            <input type="text" class="grow bg-transparent py-2" placeholder="No.Hp" name="no_hp_alumni" value="{{ $alumni->no_hp_alumni }}" readonly />
        </label>
        <span class="label-text -mb-4">Tempat, Tanggal Lahir Pegawai :</span>
        <label class="input bg-transparent border-2 border-blue-400 flex items-center gap-2 mb-5 w-full focus-within:outline-none">
        ...
        <span class="label-text -mb-4">Jenis Kelamin Alumni :</span>
        <label class="input bg-transparent border-2 border-blue-400 flex items-center gap-2 mb-5 w-full focus-within:outline-none">
            <input type="text" class="grow bg-transparent py-2" placeholder="No.Hp" name="jenis_kelamin_alumni" value="{{ $alumni->jenis_kelamin_alumni }}" readonly />
        </label>
        <span class="label-text -mb-4">Tahun Kelulusan Alumni :</span>
        <label class="input bg-transparent border-2 border-blue-400 flex items-center gap-2 mb-5 w-full focus-within:outline-none">
            <input type="text" class="grow bg-transparent py-2" placeholder="Tahun Kelulusan" name="tahun_kelulusan_alumni" value="{{ $alumni->tahun_kelulusan_alumni }}" readonly />
        </label>
        <span class="label-text -mb-4">Alamat Alumni :</span>
        <textarea class="input border-2 border-blue-400 flex items-center gap-2 mb-5 w-full h-28 focus-within:outline-none grow py-2" placeholder="Alamat" name="alamat_alumni" readonly>{{ $alumni->alamat_alumni }}</textarea>
    </div>
    <form method="dialog" class="modal-backdrop">
        <button>close</button>
    </form>
