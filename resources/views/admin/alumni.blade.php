    ...
    <div class="col-span-9 row-start-3">
        <div class="mt-5">
            <table class="table text-center">
                ...
                <tbody>
                    @foreach($direktoriAlumni as $alumniIndex => $alumni)
                    <tr class="hover">
                        <th>{{ $alumniIndex + 1 }}</th>
                        <td>
                            <div class="flex justify-center items-center gap-3">
                                <div class="avatar">
                                    <div class="mask mask-squircle w-12 h-12">
                                        <img src="{{ asset($alumni->gambar_alumni) }}"
                                ...
                                <ul tabindex="0"
                                    ...
                                    <li>
                                        <button class="btn btn-ghost w-full hover:animate-pulse"
                                            onclick="window['my_modal_edit{{ $alumni->id_alumni }}'].showModal()">
                                    ...
                                    <li>
                                        <button class="btn btn-ghost w-full hover:animate-pulse"
                                            onclick="window['my_modal_view{{ $alumni->id_alumni }}'].showModal()">
                                    ...
                                    <li>
                                        <button class="btn btn-ghost w-full hover:animate-pulse"
                                            onclick="window['my_modal_delete{{ $alumni->id_alumni }}'].showModal()">
                    ...
                    <dialog id="my_modal_edit{{ $alumni->id_alumni }}" class="modal">
                        <div class="modal-box">
                            ...
                            <form action="{{ route('DirektoriAlumni.update', ['id_alumni' => $alumni->id_alumni]) }}"
                                ...
                                <label
                                    ...
                                    <input type="text" class="grow bg-transparent border-b-2 py-2" placeholder="Nama"
                                        name="nama_alumni" value="{{ $alumni->nama_alumni }}" />
                                </label>
                                ...
                                <label
                                    ...
                                    <input type="date" class="grow bg-transparent border-r-2 py-2 w-16"
                                        placeholder="Tanggal Lahir" name="TTL_alumni"
                                ...
                                <select class="select border-elm border-2 w-full mb-5" name="jenis_kelamin">
                                    ...
                                    <option value="Laki - Laki" @if($alumni->id_alumni ===
                                        $alumni->jenis_kelamin) selected @endif>Laki - Laki</option>
                                    <option value="Perempuan" @if($alumni->id_alumni ===
                                        $alumni->jenis_kelamin) selected @endif>Perempuan</option>
                                </select>

                                <label
                                    class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                                    <input type="text" class="grow bg-transparent border-b-2 py-2"
                                        placeholder="Tahun Kelulusan" name="tahun_kelulusan_alumni"
                                        value="{{ $alumni->tahun_kelulusan_alumni }}" />
                                </label>
                        ...
                        <div class="modal-box">
                            ...
                            <label
                                ...
                                <input type="text" name="gambar_guru"
                                    class="grow file-input file-input-success border-none bg-transparent py-2"
                                    accept="gambarGuru/*" placeholder="Logo" value="{{ $alumni->gambar_alumni }}"
                                    readonly />
                            </label>
                            ...
                            <label
                                class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                                <input type="text" class="grow bg-transparent border-b-2 py-2" placeholder="Nama"
                                    name="nama_alumni" value="{{ $alumni->nama_alumni }}" readonly />
                            </label>

                            <label
                                class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                                <input type="text" class="grow bg-transparent border-b-2 py-2" placeholder="Email"
                                    name="email_alumni" value="{{ $alumni->email_alumni }}" readonly />
                            </label>

                            <label
                                class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                                <input type="text" class="grow bg-transparent border-b-2 py-2" placeholder="No.Hp"
                                    name="no_hp_alumni" value="{{ $alumni->no_hp_alumni }}" readonly />
                            </label>

                            <label
                                class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                                <input type="date" class="grow bg-transparent border-r-2 py-2 w-16"
                                    placeholder="Tanggal Lahir" name="TTL_alumni" value="{{ $alumni->TTL_alumni }}"
                                    readonly />
                                <input type="text" class="grow bg-transparent py-2" placeholder="Tempat Lahir"
                            ...
                            <textarea
                                class="input border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none grow py-2"
                                placeholder="Alamat" name="alamat_alumni"
                                readonly>{{ $alumni->alamat_alumni }}</textarea>
                    ...
                    <dialog id="my_modal_delete{{ $alumni->id_alumni }}" class="modal">
                        <div class="modal-box">
                            ...
                            <form action="{{ route('DirektoriAlumni.destroy', ['id_alumni' => $alumni->id_alumni]) }}"
                                method="post">
                                @csrf
                                @method('DELETE')
        ...
        <form action="{{ route('DirektoriAlumni.store') }}" method="post" enctype="multipart/form-data">
            ...
            <label
                ...
                <input type="text" class="grow bg-transparent border-b-2 py-2" placeholder="Tahun Kelulusan"
                    name="tahun_kelulusan_alumni" />
            </label>

            <textarea
                class="input border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none grow py-2"
                placeholder="Alamat" name="alamat_alumni"></textarea>

            <label
                class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                <input type="file" name="gambar_alumni"
                    class="grow file-input file-input-success border-none bg-transparent py-2" accept="gambarAlumni/*"
                    placeholder="Logo" />
            </label>
