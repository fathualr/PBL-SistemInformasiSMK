                ...
                <tbody>
                    ...
                    <dialog id="my_modal_edit{{ $alumni->id_alumni }}" class="modal">
                        <div class="modal-box">
                            ...
                            <form action="{{ route('DirektoriAlumni.update', ['id_alumni' => $alumni->id_alumni]) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('patch')
                                ...
                                <label class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                                    <input type="text" class="grow bg-transparent border-b-2 py-2" placeholder="Email" name="email_alumni" value="{{ $alumni->email_alumni }}" />
                                </label>
                                ...
                                <label class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                                    <input type="text" class="grow bg-transparent border-b-2 py-2" placeholder="Tahun Kelulusan" name="tahun_kelulusan_alumni" value="{{ $alumni->tahun_kelulusan_alumni }}" />
                                </label>
