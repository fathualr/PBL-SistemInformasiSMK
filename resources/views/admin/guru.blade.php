...
<dialog id="my_modal_add" class="modal">
    <div class="modal-box">
        ...
        <form action="{{ route('DirektoriGuru.store') }}" method="post" enctype="multipart/form-data">
            ...
            <label class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                <input type="date" class="grow bg-transparent border-r-2 py-2 w-16" placeholder="Tanggal Lahir" name="TTL_guru" />
    ...
    <div class="modal-box">
        ...
        <form action="{{ route('DirektoriGuru.update', $guru->id_guru) }}" method="post" enctype="multipart/form-data">
            ...
            <select class="select border-elm border-2 w-full mb-5" name="id_program">
                ...
                @foreach($programKeahlian as $program)
                <option value="{{ $program->id_program }}" {{ $guru->id_program === $program->id_program ? 'selected' : '' }}>{{ $program->nama_program }}</option>
                @endforeach
            ...
            <label class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                <input type="number" class="grow bg-transparent border-b-2 py-2" placeholder="No.Hp" name="no_hp_guru" value="{{ $guru->no_hp_guru }}" />
            </label>
            <label class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
...
<dialog id="my_modal_view{{ $guru->id_guru }}" class="modal">
    <div class="modal-box">
        ...
        <label class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
            <input type="text" class="grow bg-transparent border-b-2 py-2" placeholder="NIP" name="nik_guru" value="{{ $guru->programKeahlian->nama_program }}" readonly />
        </label>
        <label class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
