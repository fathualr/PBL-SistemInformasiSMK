        ...
        <table class="table table-xs table-pin-rows table-pin-cols w-full">
            <thead>
                <tr>
                    ...
                    <th class="p-2 md:table-cell">Nama Prasarana</th>
                    <th class="p-2 hidden md:table-cell">Tautan Foto</th>
            ...
            <tbody>
                ...
                <tr>
                    <td class="p-2 md:table-cell">{{ ($foto_prasaranas->currentPage() - 1) * $foto_prasaranas->perPage() + $key + 1 }}</td>
                    <td class="p-2 md:table-cell">{{ $foto_prasarana->prasarana->nama_prasarana }}</td>
                    <td class="p-2 hidden md:table-cell">{{ $foto_prasarana->tautan_foto }}</td>
