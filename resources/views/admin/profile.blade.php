    ...
    <div class="col-span-9 row-start-3 pb-2">
        ...
        <div class="mt-5 px-16">
            <div class="collapse collapse-arrow bg-base-200" id="sejarah">
                ...
                <div class="collapse-content">
                    <form action="{{ route('konten.update', ['id' => $konten->id_sekolah, 'field' => 'sejarah']) }}"
                        method="POST" class="grid gap-2">
                        @csrf
                        @method('PATCH')
                        <label class="form-control w-full gap-2">
        ...
        <div class="mt-5 px-16">
            <div class="collapse collapse-arrow bg-base-200" id="sambutan">
                ...
                <div class="collapse-content">
                    <form action="{{ route('konten.update', ['id' => $konten->id_sekolah, 'field' => 'sambutan']) }}"
                        method="POST" class="grid gap-2">
                        @csrf
                        @method('PATCH')
                        <label class="form-control w-full gap-2">
        ...
        <div class="mt-5 px-16">
            <div class="collapse collapse-arrow bg-base-200" id="visi">
                ...
                <div class="collapse-content">
                    <form action="{{ route('konten.update', ['id' => $konten->id_sekolah, 'field' => 'visi']) }}"
                        method="POST" class="grid gap-2">
                        @csrf
                        @method('PATCH')
                        <label class="form-control w-full gap-2">
        ...
        <div class="mt-5 px-16">
            <div class="collapse collapse-arrow bg-base-200" id="misi">
                ...
                <div class="collapse-content">
                    <form action="{{ route('konten.update', ['id' => $konten->id_sekolah, 'field' => 'misi']) }}"
                        method="POST" class="grid gap-2">
                        @csrf
                        @method('PATCH')
                        <label class="form-control w-full gap-2">
                            ...
                            <p class="text-red-500">Maaf, konten belum tersedia untuk bagian ini. Tolong isi konten agar
                                dapat ditampilkan.</p>
                            @endif<input type="text" placeholder="Type here" class="input input-bordered w-full"
                                name="misi" />
                        </label>
                        <div class="flex justify-end items-endgap-4 gap-2">
                            <button type="submit"
                    ...
                    <form
                        ...
                        <label class="form-control w-full gap-2">
                            ...
                            <p class="text-red-500">Maaf, konten belum tersedia untuk bagian ini. Tolong isi konten agar
                                dapat ditampilkan.</p>
                            @endif
                            <input type="year" placeholder="Type here" class="input input-bordered w-full"
        ...
        <div class="mt-5 px-16">
            <div class="collapse collapse-arrow bg-base-200" id="luas_tanah">
                ...
                <div class="collapse-content">
                    <form action="{{ route('konten.update', ['id' => $konten->id_sekolah, 'field' => 'luas_tanah']) }}"
                        method="POST" class="grid gap-2">
                        @csrf
                        @method('PATCH')
                        <label class="form-control w-full gap-2">
        ...
        <div class="mt-5 px-16">
            <div class="collapse collapse-arrow bg-base-200" id="teks_lokasi">
                ...
                <div class="collapse-content">
                    <form action="{{ route('konten.update', ['id' => $konten->id_sekolah, 'field' => 'teks_lokasi']) }}"
                        method="POST" class="grid gap-2">
                        @csrf
                        @method('PATCH')
                        <label class="form-control w-full gap-2">
