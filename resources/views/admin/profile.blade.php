...
<div class="grid grid-cols-9 rounded-md">
    ...
    <div class="col-span-9 row-start-3 pb-2">
        ...
        <div role="tablist" class="tabs tabs-lifted">
            <input type="radio" name="my_tabs_2" role="tab" class="tab font-bold" aria-label="Konten Umum" checked />
            <div role="tabpanel" class="tab-content bg-base-100 border-base-300 rounded-box p-6">
                ...
                <div class="mt-5 px-16">
                    ...
                    hover:file:bg-transparent hover:file:text-blue-400" name="logo_sekolah" />
                                    </label>
                                </label>
                                <div class="flex justify-end items-endgap-4 gap-2">
                                    <button type="submit"
            ...
            <input type="radio" name="my_tabs_2" role="tab" class="tab font-bold" aria-label="Halaman Beranda" />
            <div role="tabpanel" class="tab-content bg-base-100 border-base-300 rounded-box p-6">
                <!-- Teks Sambutan -->
                <div class="mt-5 px-16">
            ...
            <input type="radio" name="my_tabs_2" role="tab" class="tab font-bold" aria-label="Halaman Profil" />
            <div role="tabpanel" class="tab-content bg-base-100 border-base-300 rounded-box p-6">
