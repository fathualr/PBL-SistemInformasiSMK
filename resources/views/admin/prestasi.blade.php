...
<div class=>
                <h2 class="text-black font-bold ml-2 mt-2 mb-2 jus">Prestasi</h2>
            </div>
<!-- Open the modal using ID.showModal() method -->
<!-- Tombol untuk membuka modal utama -->
<button class="btn mb-8 mt-4 ml-20" onclick="my_modal_2.showModal()">Tambahkan Prestasi</button>

<!-- Modal utama -->
<dialog id="my_modal_2" class="modal" onclick="if (event.target === this) this.close()">
    <div class="modal-box">
        <h3 class="font-bold text-lg">Tambahkan Prestasi</h3>
