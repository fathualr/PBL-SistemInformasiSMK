        ...
        <div class="grid grid-cols-6 gap-5">
            <div class="col-span-3 card card-side bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <form
                        action="{{ route('medsos.update', ['id' => $medsos->id_media_sosial, 'field' => 'instagram']) }}"
                        method="POST">
                        @csrf
                        @method('PATCH')
            ...
            <div class="col-span-3 card card-side bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <form
                        action="{{ route('medsos.update', ['id' => $medsos->id_media_sosial, 'field' => 'facebook']) }}"
                        method="POST">
                        @csrf
                        @method('PATCH')
                        <label class="form-control w-full">
        ...
        <div class="grid grid-cols-6 gap-5">
            <div class="col-span-3 card card-side bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <form
                        action="{{ route('medsos.update', ['id' => $medsos->id_media_sosial, 'field' => 'youtube']) }}"
                        method="POST">
                        @csrf
                        @method('PATCH')
                        <label class="form-control w-full">
            ...
            <div class="col-span-3 card card-side bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <form action="{{ route('medsos.update', ['id' => $medsos->id_media_sosial, 'field' => 'tiktok']) }}"
                        method="POST">
                        @csrf
                        @method('PATCH')
                        <label class="form-control w-full">
        ...
        <div class="grid grid-cols-6 gap-5">
            <div class="col-span-3 card card-side bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <form action="{{ route('medsos.update', ['id' => $medsos->id_media_sosial, 'field' => 'email']) }}"
                        method="POST">
                        @csrf
                        @method('PATCH')
                        <label class="form-control w-full">
            ...
            <div class="col-span-3 card card-side bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <form
                        action="{{ route('medsos.update', ['id' => $medsos->id_media_sosial, 'field' => 'nomor_telepon']) }}"
                        method="POST">
                        @csrf
                        @method('PATCH')
                        <label class="form-control w-full">
        ...
        <div class="grid grid-cols-6 gap-5">
            <div class="col-span-3 card card-side bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <form action="{{ route('medsos.update', ['id' => $medsos->id_media_sosial, 'field' => 'fax']) }}"
                        method="POST">
                        @csrf
                        @method('PATCH')
                        <label class="form-control w-full">
            ...
            <div class="col-span-3 card card-side bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <form
                        action="{{ route('medsos.update', ['id' => $medsos->id_media_sosial, 'field' => 'google_map']) }}"
                        method="POST">
                        @csrf
                        @method('PATCH')
                        <label class="form-control w-full">
