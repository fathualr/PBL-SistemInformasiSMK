    ...
    <div class="col-span-9 row-start-3">
        <div class="mt-5">
            <table class="table text-center">
                ...
                <tbody>
                    @foreach($direktoriSiswa as $siswaIndex => $siswa)
                                ...
                                <ul tabindex="0"
                                    ...
                                    <li>
                                        <button class="btn btn-ghost w-full hover:animate-pulse"
                                            onclick="window['my_modal_edit{{ $siswa->id_siswa }}'].showModal()">
                                    ...
                                    <li>
                                        <button class="btn btn-ghost w-full hover:animate-pulse"
                                            onclick="window['my_modal_view{{ $siswa->id_siswa }}'].showModal()">
                                    ...
                                    <li>
                                        <button class="btn btn-ghost w-full hover:animate-pulse"
                                            onclick="window['my_modal_delete{{ $siswa->id_siswa }}'].showModal()">
                    ...
                    <!-- Edit Modal -->
                    <dialog id="my_modal_edit{{ $siswa->id_siswa }}" class="modal">
                        <div class="modal-box">
                            <form method="dialog">
                            ...
                            <form action="{{ route('DirektoriSiswa.update', ['id_siswa' => $siswa->id_siswa]) }}"
                                ...
                                <label
                                    class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                                    <input type="text" class="grow bg-transparent border-b-2 py-2" placeholder="NISN"
                                        name="nisn_siswa" value="{{ $siswa->nisn_siswa }}" />
                                </label>

                                <label
                                    class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                                    <input type="text" class="grow bg-transparent border-b-2 py-2" placeholder="Kelas"
                                        name="kelas_siswa" value="{{ $siswa->kelas_siswa }}" />
                                </label>
                                ...
                                <select class="select border-elm border-2 w-full mb-5" name="id_program">
                                    ...
                                    <option value="{{ $program->id_program }}" @if($program->id_program ===
                                        $siswa->id_program) selected @endif>{{ $program->nama_program }}</option>
                                    @endforeach
                                </select>
                                ...
                                <label
                                    ...
                                    <input type="text" class="grow bg-transparent border-b-2 py-2" placeholder="No.Hp"
                                        name="no_hp_siswa" value="{{ $siswa->no_hp_siswa }}" />
                                </label>
                                ...
                                <label
                                    ...
                                    <input type="date" class="grow bg-transparent border-r-2 py-2 w-16"
                                        placeholder="Tanggal Lahir" name="TTL_siswa" value="{{ $siswa->TTL_siswa }}" />
                                    <input type="text" class="grow bg-transparent py-2" placeholder="Tempat Lahir"
                                        name="tempat_lahir_siswa" value="{{ $siswa->tempat_lahir_siswa }}" />
                                </label>

                                <select class="select border-elm border-2 w-full mb-5" name="jenis_kelamin">
                                    <option disabled>Pilih Jenis Kelamin</option>
                                    <option value="Laki - Laki" @if($siswa->id_siswa ===
                                        $siswa->jenis_kelamin) selected @endif>Laki - Laki</option>
                                    <option value="Perempuan" @if($siswa->id_siswa ===
                                        $siswa->jenis_kelamin) selected @endif>Perempuan</option>
                                </select>

                                <textarea
                                    class="input border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none grow py-2"
                                    placeholder="Alamat" name="alamat_siswa">{{ $siswa->alamat_siswa }}</textarea>

                                <label
                                    class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                                    <input type="text" class="grow bg-transparent border-b-2 py-2"
                                        placeholder="Tahun Angkatan Siswa" name="tahun_angkatan_siswa"
                                        value="{{ $siswa->tahun_angkatan_siswa }}" />
                                </label>
                    ...
                    <!-- View Modal -->
                    <dialog id="my_modal_view{{ $siswa->id_siswa }}" class="modal">
                        <div class="modal-box">
                            <form method="dialog">
                                <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
                            </form>
                            ...
                            <label
                                ...
                                <input type="text" name="gambar_siswa"
                                    class="grow file-input file-input-success border-none bg-transparent py-2"
                                    accept="gambarSiswa/*" placeholder="Logo" value="{{ $siswa->gambar_siswa }}"
                                    readonly />
                            </label>
                            ...
                            <label
                                class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                                <input type="text" class="grow bg-transparent border-b-2 py-2" placeholder="Nama"
                                    name="nama_siswa" value="{{ $siswa->nama_siswa }}" readonly />
                            </label>

                            <label
                                class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                                <input type="text" class="grow bg-transparent border-b-2 py-2" placeholder="NISN"
                                    name="nisn_siswa" value="{{ $siswa->nisn_siswa }}" readonly />
                            </label>

                            <label
                                class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                                <input type="text" class="grow bg-transparent border-b-2 py-2" placeholder="Kelas"
                                    name="kelas_siswa" value="{{ $siswa->kelas_siswa }}" readonly />
                            </label>
                            ...
                            <label
                                class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                                <input type="text" class="grow bg-transparent border-b-2 py-2" placeholder="No.Hp"
                                    name="no_hp_siswa" value="{{ $siswa->no_hp_siswa }}" readonly />
                            </label>
                            ...
                            <label
                                ...
                                <input type="date" class="grow bg-transparent border-r-2 py-2 w-16"
                                    ...
                                    readonly />
                                <input type="text" class="grow bg-transparent py-2" placeholder="Tempat Lahir"
                                    name="tempat_lahir_siswa" value="{{ $siswa->tempat_lahir_siswa }}" readonly />
                            </label>
                            ...
                            <textarea
                                class="input border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none grow py-2"
                                placeholder="Alamat" name="alamat_siswa" readonly>{{ $siswa->alamat_siswa }}</textarea>

                            <label
                                class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                                <input type="text" class="grow bg-transparent border-b-2 py-2"
                                    placeholder="Tahun Angkatan Siswa" name="tahun_angkatan_siswa"
                                    value="{{ $siswa->tahun_angkatan_siswa }}" readonly />
                            </label>
                    ...
                    <!-- Delete Modal -->
                    <dialog id="my_modal_delete{{ $siswa->id_siswa }}" class="modal">
                        <div class="modal-box">
                            <form method="dialog">
                                <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
                            </form>
                            ...
                            <form action="{{ route('DirektoriSiswa.destroy', ['id_siswa' => $siswa->id_siswa]) }}"
                                method="post">
                                @csrf
                                @method('DELETE')
...
<dialog id="my_modal_add" class="modal">
    <div class="modal-box">
        ...
        <form action="{{ route('DirektoriSiswa.store') }}" method="post" enctype="multipart/form-data">
            ...
            <label
                class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                <input type="text" class="grow bg-transparent border-b-2 py-2" placeholder="NISN" name="nisn_siswa" />
            </label>
            ...
            <label
                class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                <input type="file" name="gambar_siswa"
                    class="grow file-input file-input-success border-none bg-transparent py-2" accept="gambarSiswa/*"
                    placeholder="Logo" />
            </label>
