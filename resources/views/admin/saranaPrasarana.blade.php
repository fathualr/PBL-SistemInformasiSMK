...
<div>
     <h2 class="text-black font-bold ml-2 mt-2 mb-2 jus">Prasarana</h2>
</div>
<button class="btn mb-8 mt-4 ml-20" onclick="my_modal_2.showModal()">Tambahkan Prasarana</button>

<!-- Modal utama -->
<dialog id="my_modal_2" class="modal" onclick="if (event.target === this) this.close()">
    <div class="modal-box">
        <h3 class="font-bold text-lg">Tambahkan Prasarana</h3>
        <label class="input input-bordered flex items-center gap-2 mt-4 mb-4">
            Nama Item :
            <input type="text" class="grow" placeholder="....." />
        </label>
        <label class="input input-bordered flex items-center gap-2 mt-4 mb-3">
            Deskripsi :
            <input type="text" class="grow" placeholder="......" />
        </label>
...
<a href="" class="">
    <button type="submit"
        ...
        <dialog id="my_modal_3" class="modal" onclick="if (event.target === this) { this.close(); my_modal_2.close(); }">
            <div class="modal-box">
                <h3 class="font-bold text-lg ">Item berhasil ditambahkan</h3>
            </div>
        </dialog>
