            ...
            <table class="table text-center">
                ...
                <tbody>
                    ...
                    <tr class="hover">
                        ...
                        <th class="w-8">1</th>
                        <td class="w-8">Pengdaftaran</td>
                        <td class="w-8"><input type="date"></td>
                        <td>
                            <p class="truncate w-64 mx-auto">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi eos at fugiat hic nesciunt vel ipsam cumque blanditiis asperiores, quis veritatis quos consequatur non quas suscipit deleniti architecto ab laboriosam.</p>
                        </td>
                        <td class="w-8">
                    ...
                    <tr class="hover">
                        ...
                        <th class="w-8">1</th>
                        <td class="w-8">Verifikasi Dokumen</td>
                        <td class="w-8"><input type="date"></td>
                        <td>
                            <p class="truncate w-64 mx-auto">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi eos at fugiat hic nesciunt vel ipsam cumque blanditiis asperiores, quis veritatis quos consequatur non quas suscipit deleniti architecto ab laboriosam.</p>
                        </td>
                    ...
                    <tr class="hover">
                        ...
                        <th class="w-8">1</th>
                        <td class="w-8">Pengumpulan Hasil</td>
                        <td class="w-8"><input type="date"></td>
                        <td>
                            <p class="truncate w-64 mx-auto">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi eos at fugiat hic nesciunt vel ipsam cumque blanditiis asperiores, quis veritatis quos consequatur non quas suscipit deleniti architecto ab laboriosam.</p>
                        </td>
    ...
    <div class="modal-box">
        ...
        <form action="">
            ...
            <label class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                <input type="text" class="grow bg-transparent py-2" placeholder="Judul" />
            </label>

            <label class="input bg-transparent border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none">
                <input type="date" class="grow bg-transparent py-2" placeholder="Tanggal" />
            </label>

            <textarea class="input border-2 border-elm flex items-center gap-2 mb-5 w-full focus-within:outline-none grow bg-transparent py-2" placeholder="Deskripsi Judul"></textarea>
