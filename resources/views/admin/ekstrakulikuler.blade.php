    ...
    <div class="modal-box w-11/12 max-w-5xl py-0">
        ...
        <form action="{{ route('Ekstrakulikuler.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="grid gap-y-5">
                ...
                <textarea class="textarea border-2 border-blue-400 w-full" placeholder="Deskripsi Ekstrakulikuler"
...
<dialog id="my_modal_view{{ $ekskul->id_ekstrakurikuler }}" class="modal">
    <div class="modal-box w-11/12 max-w-5xl py-0">
        ...
        <div class="grid gap-y-5 mb-10">
            ...
            <span class="label-text -mb-4">Deskripsi Ekstrakurikuler :</span>
            <textarea class="textarea border-2 border-blue-400 w-full" placeholder="Deskripsi Ekstrakulikuler"
                name="deskripsi_ekstrakurikuler" readonly>{{ $ekskul->deskripsi_ekstrakurikuler }}</textarea>
