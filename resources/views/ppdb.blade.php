...
<div class="mx-auto bg-white rounded-md ">
    ...
    <span>Lorem Ipsum is placeholder text commonly used in the design and typesetting industry. It's derived from
        sections of a Latin text by Cicero, written in 45 BC, titled "de Finibus Bonorum et Malorum" (On the Ends of
        Goods and Evils). The Lorem Ipsum text, however, is not a coherent or meaningful passage. Instead, it consists
        of scrambled Latin words, making it ideal for demonstrating the visual presentation of textual elements such as
        font, typography, and layout without the distraction of meaningful content. It's often used in graphic design,
        web design, and typesetting as a placeholder until the final content is available.</span>
    <!-- ALur PPDB -->
    <div class="divider">
        ...
        <ul class="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
            <li>
                ...
                <div class="timeline-start md:text-end mb-10">
                    ...
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab consectetur maiores doloribus architecto
                    repudiandae aliquid, alias maxime quasi deleniti sapiente omnis harum nisi quisquam natus nulla
                    eaque optio sed pariatur.
                </div>
                <hr />
            </li>
            <li>
                ...
                <div class="timeline-end mb-10">
                    ...
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis explicabo error excepturi officiis
                    veritatis blanditiis hic, iste eius reiciendis pariatur incidunt omnis itaque, accusamus porro sit
                    sapiente! Ullam, rerum nam!
                    Aperiam suscipit quibusdam sunt minima pariatur omnis doloribus magni tempore? Esse asperiores sit
                    sequi omnis laudantium dolorem, magnam possimus officia necessitatibus nemo unde, excepturi
                    voluptatum dolore consectetur, non veritatis! Recusandae?
                </div>
                <hr />
            </li>
            <li>
                ...
                <div class="timeline-start md:text-end mb-10">
                    ...
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe doloribus dolorem veritatis
                    perspiciatis animi dolores inventore ad quis corrupti. Ullam error facere earum nobis exercitationem
                    totam, dolorum quod necessitatibus voluptates!
                </div>
                <hr />
            </li>
            <li>
                ...
                <div class="timeline-end mb-10">
                    ...
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam, deserunt. Repellendus quisquam
                    aliquam asperiores! Maxime nesciunt asperiores praesentium magnam. Illum nesciunt quae distinctio
                    ab, neque iusto quidem alias provident deserunt?
                </div>
                <hr />
            </li>
        </ul>
    ...
    <form action="/ppdb" method="GET">
        ...
        <div class="space-y-4 my-5">
            ...
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-8 ">
                    <input type="text" id="no_telepon" name="no_telepon" class="input input-bordered w-full"
            ...
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-8 ">
                    <input type="text" id="kota_sekolah_asal" name="kota_sekolah_asal"
                        class="input input-bordered w-full" placeholder="Kota Sekolah Asal">
                </div>
            </div>
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-4">
            ...
            <div class="flex justify-center">
                <button class="btn btn-success font-bold text-white w-40 my-5">Kirim</button>
            </div>
        </div>
    </form>
</div>
